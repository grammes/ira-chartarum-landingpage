...
|-------|-------------|-------------|
| 1 | Quick Bug Fix | [Level 1 Map](./github/instructions/rules/visual-maps/level1-map.md) |
| 2 | Simple Enhancement | [Level 2 Map](./github/instructions/rules/visual-maps/level2-map.md) |
| 3 | Intermediate Feature | [Level 3 Map](./github/instructions/rules/visual-maps/level3-map.md) |
| 4 | Complex System | [Level 4 Map](./github/instructions/rules/visual-maps/level4-map.md) |
