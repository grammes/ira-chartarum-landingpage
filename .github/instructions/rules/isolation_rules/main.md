...
> **TL;DR:** This system is designed to work with Copilot smart actions, where each mode loads only the rules it needs. The system uses visual Mermaid diagrams and selective document loading to optimize context usage.

## 🧭 MODE-SPECIFIC VISUAL MAPS

```mermaid
graph TD
    subgraph Modes["Copilot Smart Actions"]
